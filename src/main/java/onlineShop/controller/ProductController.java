...
@Controller
//Let spring mvc know about this, spring will setup all method
public class ProductController {
    ...
    public ModelAndView getAllProducts() {
        ...
        // give all LIst<product> to ModelAndView , find productList.jsp, replace products with products
    }
    ...
    public ModelAndView getProductForm() {
        ...
        // could add multiple replacement, since it will pass a LinkedHashMap<String, object>
    }

    @RequestMapping(value = "/admin/product/addProduct", method = RequestMethod.POST)
    public String addProduct(@ModelAttribute Product product, BindingResult result) {
        //binding result, check if binding is correct
        if (result.hasErrors()) {
            return "addProduct";
        }
    ...
    //here, user click the delete btn, it is a get request, but we know it represent delete
